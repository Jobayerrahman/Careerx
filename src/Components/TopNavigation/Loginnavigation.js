        ...
        return (
            <Fragment>
                <Navbar fixed="top" className={this.state.navBarBack} collapseOnSelect expand="lg" variant="dark">
                    <Navbar.Brand><Link className={this.state.navBarTitle} to="/Home">CareerX</Link></Navbar.Brand>
                    <Navbar.Toggle onClick={this.toggleBtn} aria-controls="responsive-navbar-nav" />
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="mr-auto">
                        <Nav.Link><NavLink exact activeStyle={{color:'#00a8ee'}} className={this.state.navBarItem} to="/Postjob">Post job</NavLink></Nav.Link>
                        ...
                        <Nav.Link><NavLink exact activeStyle={{color:'#00a8ee'}} className={this.state.navBarItem} to="/SignIn">Profile</NavLink></Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Navbar>
            </Fragment>
